...
\input{appendix/steam_sat.tex}

% Superheated Tables
\input{appendix/steam_super.tex}

% Compressed Liquid Tables
\input{appendix/water_compressed.tex}
\restoregeometry
...
\newgeometry{margin=1.0 in}
\input{appendix/R134a_sat.tex}
\input{appendix/R134a_super.tex}
